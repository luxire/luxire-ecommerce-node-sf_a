...
exports.standard_sizes =  function(req, res){
  ...
  console.log(constants.spree.host+"/get_standard_size?token="+req.headers['X-Spree-Token']+'&fit_type='+fit_type+'&neck='+neck);
  http
    .get(constants.spree.host+"/get_standard_size?"+'&fit_type='+fit_type+'&neck='+neck,
